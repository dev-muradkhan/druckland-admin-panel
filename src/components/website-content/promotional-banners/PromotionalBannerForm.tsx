...
import { PromotionalBannerFormData, BannerButton } from '@/types/banners';

interface PromotionalBannerFormProps {
  initialData?: PromotionalBannerFormData;
  onSubmit: (data: PromotionalBannerFormData, exit?: boolean) => Promise<void>;
...
const PromotionalBannerForm: React.FC<PromotionalBannerFormProps> = ({
  initialData,
  onSubmit,
  onDelete
}) => {
  ...
  const [formData, setFormData] = useState<PromotionalBannerFormData>(
    initialData || {
      name: '',
      assignmentType: 'page',
      assignedTo: '',
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.assignedTo) {
      toast.error(`Please select a ${formData.assignmentType} to assign this promotional banner to`);
      return false;
    }
    ...
    // If there's an offer end time, make sure it's in the future
    if (formData.offerEndTime) {
      const endTime = new Date(formData.offerEndTime);
      const now = new Date();
  ...
  const handleSubmit = async (e: React.FormEvent, exit: boolean = false) => {
    ...
    try {
      ...
      toast.error(`Failed to ${isEditMode ? 'update' : 'create'} promotional banner`);
    } finally {
  ...
  const handleDelete = async () => {
    ...
    const confirmed = window.confirm('Are you sure you want to delete this promotional banner?');
    if (!confirmed) return;
  ...
  return (
    <form className="promotional-banner-form">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left Column - Banner Settings & Assignment */}
        <div className="col-span-1 space-y-6">
          {/* Basic Banner Information */}
          <div className="promotional-banner-form__basic-info bg-white rounded-md border border-[#E4E7EB] overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              <div className="promotional-banner-form__field">
                ...
                <input
                  ...
                  placeholder="Enter promotional banner name"
          ...
          {/* Status */}
          <div className="promotional-banner-form__status bg-white rounded-md border border-[#E4E7EB] overflow-hidden">
            <div className="bg-[#F8F9FA] border-b border-[#E4E7EB] px-6 py-4">
          ...
          {/* Action Buttons */}
          <div className="promotional-banner-form__actions bg-white rounded-md border border-[#E4E7EB] overflow-hidden">
            <div className="bg-[#F8F9FA] border-b border-[#E4E7EB] px-6 py-4">
        ...
        <div className="col-span-1 lg:col-span-2 space-y-6">
          {/* Banner Content */}
          <div className="promotional-banner-form__content bg-white rounded-md border border-[#E4E7EB] overflow-hidden">
            <div className="bg-[#F8F9FA] border-b border-[#E4E7EB] px-6 py-4">
          ...
          {/* Offer & Timer */}
          <div className="promotional-banner-form__offer bg-white rounded-md border border-[#E4E7EB] overflow-hidden">
            <div className="bg-[#F8F9FA] border-b border-[#E4E7EB] px-6 py-4">
              <h2 className="text-[#2B4F60] text-lg font-semibold">Offer & Timer Management</h2>
            </div>
            
            <div className="p-6 space-y-4">
              <div className="promotional-banner-form__field">
                <label htmlFor="offerCode" className="block text-sm font-medium text-[#49617E] mb-1">
                  Offer or Coupon Code
                </label>
                <div className="relative">
                  <Tag size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#6F8591]" />
                  <input
                    type="text"
                    id="offerCode"
                    name="offerCode"
                    ...
                    onChange={handleInputChange}
                    placeholder="Enter offer code (e.g., SUMMER25)"
                ...
                <p className="text-xs text-[#6F8591] mt-1">
                  Leave empty if you don't want to display an offer code
                </p>
              </div>
              
              <div className="promotional-banner-form__field">
                <label htmlFor="offerEndTime" className="block text-sm font-medium text-[#49617E] mb-1">
                  Offer End Time
                </label>
                <div className="relative">
                  <Clock size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#6F8591]" />
                  <input
                    type="datetime-local"
                    id="offerEndTime"
                    name="offerEndTime"
                    value={formatDateTimeForInput(formData.offerEndTime)}
                    onChange={handleInputChange}
                    className="w-full pl-9 pr-3 py-2 border border-[#E4E7EB] rounded-md focus:outline-none focus:ring-1 focus:ring-[#007BF9] focus:border-[#007BF9]"
                  />
                </div>
                <p className="text-xs text-[#6F8591] mt-1">
                  Set a deadline for the offer to display a countdown timer
                </p>
              </div>
              
              <div className="promotional-banner-form__field">
                <label htmlFor="instructionText" className="block text-sm font-medium text-[#49617E] mb-1">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder="Enter instructions (e.g., Use code at checkout)"
                  className="w-full px-4 py-2 border border-[#E4E7EB] rounded-md focus:outline-none focus:ring-1 focus:ring-[#007BF9] focus:border-[#007BF9]"
                />
                <p className="text-xs text-[#6F8591] mt-1">
                  A short note about how to use the promotion
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Banner Buttons */}
          <div className="promotional-banner-form__buttons bg-white rounded-md border border-[#E4E7EB] overflow-hidden">
              ...
              {(!formData.buttons || formData.buttons.length === 0) ? (
                ...
                <div className="space-y-5">
                  {formData.buttons.map((button, index) => (
                    <div key={index} className="promotional-banner-form__button-item bg-[#F8F9FA] border border-[#E4E7EB] rounded-md p-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="promotional-banner-form__field md:col-span-2">
                          <label className="block text-xs font-medium text-[#49617E] mb-1">
          ...
          {/* Banner Image */}
          <div className="promotional-banner-form__image bg-white rounded-md border border-[#E4E7EB] overflow-hidden">
            <div className="bg-[#F8F9FA] border-b border-[#E4E7EB] px-6 py-4">
            ...
            <div className="p-6 space-y-4">
              {formData.image ? (
                <div className="promotional-banner-form__image-preview">
                  <div className="relative">
                    <div className="w-full h-48 relative border border-[#E4E7EB] rounded-md overflow-hidden">
                      <Image
                        src={formData.image.url}
                        alt={formData.image.alt || 'Promotional banner image'}
                        fill
                ...
                <div className="promotional-banner-form__image-upload">
